...
class EnStopWords : StopWords {

    private val stopWords = arrayListOf("a", "a's", "able", "about", "above", "according",
        ...
        "d", "definitely", "described", "despite", "did", "didn't", "different", "do", "does",
        ...
        "keep", "keeps", "kept", "know", "known", "knows", "l", "last", "lately", "later",
    ...
    override fun isStopWord(stopWord: String): Boolean {
