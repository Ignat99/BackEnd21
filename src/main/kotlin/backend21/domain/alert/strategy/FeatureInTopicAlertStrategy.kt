...
class FeatureInTopicAlertStrategy @Autowired constructor(
    ...
    projectAlertExecutionRepository, project, feature, "analysis.topics.topic",
    AlertConstants.TOPIC_ALIAS, "feature", date)
{
    override fun getName(): String = AlertConstants.TOPIC_ALIAS
}
