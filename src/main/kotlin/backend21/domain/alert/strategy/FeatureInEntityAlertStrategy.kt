...
class FeatureInEntityAlertStrategy @Autowired constructor(
    ...
    projectAlertExecutionRepository, project, feature, "analysis.entities.entity",
    AlertConstants.ENTITY_ALIAS, "feature", date)
{
    override fun getName(): String = AlertConstants.ENTITY_ALIAS
}
